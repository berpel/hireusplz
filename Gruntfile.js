module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    uglify: {
      dev: {
        ...
        files: {
          'public/js/hireusplz.min.js': [ 'tmp/base.annotated.js', 'tmp/**/*.annotated.js' ],
      ...
      prod: {
        ...
        files: {
          'public/js/hireusplz.min.js': [ 'tmp/assets/js/base.annotated.js', 'tmp/assets/js/**/*.annotated.js' ],
          'public/js/vendor.min.js': [ 'app/assets/vendor/angular.js', 'app/assets/vendor/**/*.js' ]
        }
      }
    },
    ...
    strip : {
      main : {
        src : 'public/js/hireusplz.min.js',
        dest : 'public/js/hireusplz.min.js',
        options : {
          nodes : ['console.log']
        }
      }
  ...
  //grunt.registerTask('prod', ['clean:build', 'ngAnnotate:dev', 'uglify:prod', 'clean:annotated', 'concurrent:assets', 'strip']);
  //grunt.registerTask('diesel', ['clean:build', 'ngAnnotate:dev', 'uglify:prod', 'clean:annotated', 'concurrent:assets']);
  //grunt.registerTask('dev', ['clean:build', 'ngAnnotate:dev', 'uglify:dev', 'clean:annotated', 'concurrent:assets']);
